...
//  MIDIobjects[6].inputMin = 400;  
//  MIDIobjects[6].inputMax = 300;  
...
//  MIDIobjects[10].outputMax = 127; 
  ...
  const int RELEASE_THRESHOLD = 5;
   ...
   MIDIobjects[0].touchThreshold = TOUCH_THRESHOLD;   // always make sure that the touch threshold is
   MIDIobjects[0].releaseThreshold = RELEASE_THRESHOLD; // larger than the release threshold - larger values
   ...
   MIDIobjects[10].touchThreshold = TOUCH_THRESHOLD;  
   MIDIobjects[10].releaseThreshold = RELEASE_THRESHOLD; 
  //
  ...
  // MIDIobjects[11].touchThreshold = TOUCH_THRESHOLD;  
  // MIDIobjects[11].releaseThreshold = RELEASE_THRESHOLD; 
